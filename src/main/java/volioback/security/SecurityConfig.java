...
import volioback.security.Filter.CustomAuthFilter;
import volioback.security.Filter.CustomAuthorisationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/v2/api-docs/**", "/v2/api-docs**", "/webjars/**").permitAll();
